...
function receivedOfferChanged(offer, oldState) {
    ...
    if (offer.state != TradeOfferManager.ETradeOfferState.Active) {
        ...
        Screenshot.receivedOfferChanged(offer.id, function (err, id) {
            ...
            Automatic.alert('trade', 'Offer #' + offer.id + ' sent by ' + offer.partner.getSteamID64() + ' is now marked as ' + TradeOfferManager.ETradeOfferState[offer.state] + ', view it here https://tf2automatic.com/trades?id=' + id);
        });
    }
