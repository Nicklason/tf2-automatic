declare module 'steam-totp' {
    ...
    export function getAuthCode (secret: string, callback: (err: Error|null, code?: string, offset?: number, latency?: number) => void): void;
    export function getAuthCode (secret: string, timeOffset: number, callback: (err: Error|null, code?: string, offset?: number, latency?: number) => void): void;
    ...
    export function generateAuthCode (secret: string, callback: (err?: Error, code?: string, offset?: number, latency?: number) => void): void;
    export function generateAuthCode (secret: string, timeOffset: number, callback: (err?: Error, code?: string, offset?: number, latency?: number) => void): void;
